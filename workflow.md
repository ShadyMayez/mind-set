...
### UNDERSTAND
- What exactly does the ticket require?
- What should the user experience?

### EXPLORE
- Where is the current functionality?
- How does the data flow?

### REFERENCE
- Where does the repository already solve something similar?
...
### CONTROL
Is Codex following the approved plan?

### REUSE
Are we following existing patterns?

### SCOPE
Is Codex changing only what is necessary?

### CHECKPOINT
Does each meaningful step still make sense?
...
### EDGE CASES
What unusual situations could break it?

### REGRESSION
Did we break existing functionality?

### REVIEW
Would I approve this as a pull request?

### FIX
Correct real issues.

### VERIFY AGAIN
Prove the final version works.
